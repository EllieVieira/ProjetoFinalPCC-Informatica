...
// die();
    ...
    // exit();
        ...
        // $sql = "update respostas set votos= ($votos) where id = '$resposta_id '";
        // $result_avaliacoes = mysqli_query($conn, $sql);

        // var_dump($sql);

        // $sql = "update respostas set PONTUACAO= (($resposta + $valorAvaliacao) / ($votos)) where id = '$resposta_id '";
        // $result_avaliacoes = mysqli_query($conn, $sql);
        // var_dump($sql);
        // die;
